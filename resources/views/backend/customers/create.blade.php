    ...
    <div x-data="createCustomer">
        <form @submit.prevent="addCustomer($event)">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3">
                <div>
                    <x-forms.input-label for="first_name">First Name <span
                            class="text-red-500">*</span></x-forms.input-label>
                    <x-forms.text-input class="w-full" id="first_name" name="first_name" />
                </div>
                <div>
                    <x-forms.input-label for="last_name">Last Name <span
                            class="text-red-500">*</span></x-forms.input-label>
                    <x-forms.text-input class="w-full" id="last_name" name="last_name" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3 mt-3">
                <div>
                    <x-forms.input-label for="email">Email Address <span
                            class="text-red-500">*</span></x-forms.input-label>
                    <x-forms.text-input class="w-full" id="email" name="email" />
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3">
                ...
                <div>
                    <x-forms.input-label for="state">State <span
                            class="text-red-500">*</span></x-forms.input-label>
                    <x-forms.text-input class="w-full" id="state" name="state" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3 mt-3">
                <div>
                    ...
                    <x-forms.text-input class="w-full" id="city" name="city" />
                </div>
                <div>
                    <x-forms.input-label for="zip_code">Zip code <span
                            class="text-red-500">*</span></x-forms.input-label>
                    <x-forms.text-input class="w-full" id="zip_code" name="zip_code" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3 mt-3">
                <div>
                    <x-forms.input-label for="address">Address <span
                            class="text-red-500">*</span></x-forms.input-label>
                    <x-forms.text-input class="w-full" id="address" name="address" />
                </div>
            </div>
            <div class="border-b border-slate-200 my-5"></div>
